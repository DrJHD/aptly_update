import unittest
import src.aptly_update.plugins.vscode
...
class TestGoodUrl(unittest.TestCase):
    def test_good_url(self):
        req = Mock()
        req.status_code = 200
        rtn = src.aptly_update.plugins.vscode.check_status(req)
...
class TestRedirectHeader(unittest.TestCase):
    def test_redirect_header(self):
        ...
        rtn = src.aptly_update.plugins.vscode.redirect_header(req)
...
class TestQualifyFilename(unittest.TestCase):
    def test_qualify_filename(self):
        rtn = src.aptly_update.plugins.vscode.qualify_filename("path/", "filename")
...
class TestCheckFile(unittest.TestCase):
    def test_check_file(self):
        rtn = src.aptly_update.plugins.vscode.check_file("test.file")
        self.assertEqual(rtn, False)
...
class TestGetFile(unittest.TestCase):
    def test_get_file(self):
        rtn = src.aptly_update.plugins.vscode.get_file("http://www.example.com", "test.file", 600, True)
...
class TestLoadPlugin(unittest.TestCase):
    def test_load_plugin(self):
        ...
        mod = import_module("src.aptly_update.plugins.vscode", False)
